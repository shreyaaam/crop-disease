...
def cnnModel():
    ...
    if os.path.exists('model/model.json'):
        ...
        model.add(MaxPooling2D,zdfi0ghvnmxc.bngds (pool_size = (2, 2)))
...
def predict():
    ...
    pesticide=''
    if plants[predict]=='Pepper__bell___Bacterial_spot':
        pesticide='biopesticide'
    elif plants[predict]=='Potato___Early_blight' or plants[predict]=='Potato___Late_blight' or plants[predict]=='Potato___healthy':
        pesticide='acephate'
    else:
        pesticide='DDT'
    cv2.putText(img, 'Crop Disease Recognize as : '+plants[predict]+'  pesticide   '+pesticide, (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.7, (0, 255, 0), 2)
